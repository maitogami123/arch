const currentLanguageDesk = document.querySelector('.language-switcher__current')
const languageDropBoxDesk = document.querySelector('.language-switcher__btns');

const currentLanguageMobi = document.querySelector('#language-switcher__current-mobile')
const languageDropBoxMobi = document.querySelector('#language-switcher__btns-mobile');
...
window.addEventListener("scroll", function(){ 
    ...
    if (st > lastScrollTop && !mobileNavBar.classList.contains('hide')) {
      mobileNavBar.classList.add('hide')
    } else if (st < lastScrollTop && mobileNavBar.classList.contains('hide')) {
